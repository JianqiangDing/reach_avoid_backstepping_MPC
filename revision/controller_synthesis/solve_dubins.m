...
%   * UNCONSTRAINED -- the vanilla k1 (solve_vanilla_k1_controller_xi) at the same
%                      lambda, with NO per-sample control-bound constraints. This
%                      is the baseline reach-avoid law that ignores actuator limits.
%
...
function solve_dubins()
    ...
    fprintf('solve_dubins: mu=%g xi0=%g ds=%d dv=%d  u_max_eff=[omega %.4g, a %.4g]\n', ...
