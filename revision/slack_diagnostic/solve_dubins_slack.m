...
%   synthesis/SOP : MU, XI0, UB, N_VALID, SLACK_WEIGHT, DS, DV
%   sampling      : SEED
% The Dubins EOM, output map and safe/target sets are the frozen example
% definition (mirrored read-only in dubins_slack_diag.ipynb §1).
